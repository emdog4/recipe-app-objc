...
NSString * const kDataManagerBundleName = @"RecipePro";
NSString * const kDataManagerModelName = @"RecipePro";
NSString * const kDataManagerSQLiteName = @"RecipePro.sqlite";
...
- (void)preloadData
{
//    Recipe *recipe = [NSEntityDescription insertNewObjectForEntityForName:@"Recipe" inManagedObjectContext:self.mainObjectContext];
//    
//    recipe.name = @"garlic butter spaghetti with spinach, sun-dried tomatoes and olives";
//    recipe.category = @"vegan, simple, favorite";
//    recipe.prep = @10;
//    recipe.total = @30;
//    recipe.serves = @4;
//    
